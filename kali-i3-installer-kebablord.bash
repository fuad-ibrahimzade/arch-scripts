...
apt install i3blocks rxvt-unicode rxvt-unicode-256color suckless-tools xfonts-terminus network-manager-gnome gxkb pnmixer nautilus mpv feh xclip xsel htop neofetch tree jq -y
...
cd /live-build-config
mv ./kali-config/common/includes.chroot/etc/skel/* /home/user
mv ./kali-config/common/includes.chroot/* ./